...
const initConnectWithSessionIdMutation = graphql`
  mutation InitConnectWithSessionIdMutation($sessionId: String!) {
    initConnectWithSessionId(sessionId: $sessionId)
  }
`;

function commitInitConnectWithSessionId(
  ...
  commitMutation(environment, {
    mutation: initConnectWithSessionIdMutation,
    variables,
...
export default commitInitConnectWithSessionId;
