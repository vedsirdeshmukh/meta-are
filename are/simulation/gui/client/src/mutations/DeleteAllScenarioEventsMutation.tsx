...
const deleteAllScenarioEventsMutation = graphql`
  mutation DeleteAllScenarioEventsMutation($sessionId: String!) {
    deleteAllScenarioEvents(sessionId: $sessionId)
  }
`;

function commitDeleteAllScenarioEvents(
  ...
  commitMutation(environment, {
    mutation: deleteAllScenarioEventsMutation,
    variables,
...
export default commitDeleteAllScenarioEvents;
